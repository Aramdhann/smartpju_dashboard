<?php
session_start();
require '../core2/connection.php' // memanggil file connection
?>
...
<div class="mt-2" style="margin-bottom: 100px;">
    ...
    <table id="example" class="display table table-sm" cellspacing="0" width="100%">
        ...
        <tbody id="refresh">
            ...
            $datas = mysqli_query($connect, "SELECT * FROM tbl_sensor2 ORDER BY id DESC"); // script untuk menampilkan data
            ?>
